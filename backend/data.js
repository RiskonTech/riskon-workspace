{
  "120397": {
    ...
    "riskDrivers": ["Consistent payment history", "Low credit utilization", "Stable income-to-debt ratio"],
    "history": [
  ...
  "205743": {
    ...
    "riskDrivers": ["Recent increase in default probability", "New credit lines opened recently", "Moderate credit utilization"],
    "history": [
  ...
  "229335": {
    ...
    "riskDrivers": ["History of high-risk activity (7 years prior)", "Stable but moderate default probability", "Multiple active credit lines"],
    "history": [
  ...
  "234968": {
    ...
    "riskDrivers": ["Positive recent trend (risk decreasing)", "Previous period of medium-to-high risk", "Diversified credit mix"],
    "history": [
  ...
  "257537": {
    ...
    "riskDrivers": ["High and consistent probability of default", "Borderline medium/high risk in preceding months", "History of late payments"],
    "history": [
  ...
  "338391": {
    ...
    "riskDrivers": ["Sharp, recent increase into high-risk category", "Volatile credit history", "High recent credit inquiries"],
    "history": [
  ...
  "348704": {
    ...
    "riskDrivers": ["Extreme volatility in risk profile", "Recent history of near-maximum default probability (>0.9)", "High outstanding debt balance"],
    "history": [
  ...
  "419683": {
    ...
    "riskDrivers": ["Steady increase in risk over recent months", "Volatile credit history", "Shift from Low to Medium risk category"],
    "history": [
  ...
  "440013": {
    ...
    "riskDrivers": ["Recent period of high default probability (>0.72)", "Significant financial instability indicated", "Multiple high-balance accounts"],
    "history": [
